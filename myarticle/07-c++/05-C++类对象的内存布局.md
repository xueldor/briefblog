...
![image-20211112155121400](_img/image-20211112155121400.png)
...
4. 只有一个虚函数的类
   ...
   fun的实体当然还是在代码区，但是对象里多了一个vfptr和一个vftable。
...
10. 添加一些方法，有虚函数，有普通函数
    ...
    ![image-20211115154004730](_img/image-20211115154004730.png)
